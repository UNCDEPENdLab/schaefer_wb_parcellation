...
cp ${Schaefer_srcdir}/freeview_lut/Schaefer2018_${nSchaefer}Parcels_7Networks_order.txt ./schaefer_${nSchaefer}_labels.txt
./schaefer_parcels_to_labels.R schaefer_${nSchaefer}_labels.txt
rm schaefer_${nSchaefer}_labels.txt
...
if [ -n "$ref_2009c" ]; then 
    ...
    applywarp -i Schaefer_$((nSchaefer + nAddl))_final_${sz}mm -o Schaefer_$((nSchaefer + nAddl))_final_2009c_${output_res}mm --interp=nn \
	  -w $MRI_STDDIR/fsl_mni152/fsl_mni152_to_fonov_mni152_warpcoef -r $MRI_STDDIR/mni_icbm152_nlin_asym_09c/mni_icbm152_t1_tal_nlin_asym_09c_${output_res}mm
fi
...
# echo "roi_num,hemi,network,subregion" > region_labels.csv
# for (( i=1; i <= $nSchaefer; i++ ));
# do
# echo "$i,"
# done

cp schaefer_${nSchaefer}_labels.csv region_labels.csv

cat << EOF >> region_labels.csv
# Subcortical region labels
$((nSchaefer + 1)),L,,BLA
$((nSchaefer + 2)),R,,BLA
$((nSchaefer + 3)),L,,CMN
$((nSchaefer + 4)),R,,BLA
$((nSchaefer + 5)),L,,Thalamus (Prefrontal)
$((nSchaefer + 6)),L,,Thalamus (Premotor)
$((nSchaefer + 7)),L,,Thalamus (Posterior parietal)
$((nSchaefer + 8)),L,,Thalamus (Temporal)
$((nSchaefer + 9)),R,,Thalamus (Prefrontal)
$((nSchaefer + 10)),R,,Thalamus (Premotor)
$((nSchaefer + 11)),R,,Thalamus (Posterior parietal)
$((nSchaefer + 12)),R,,Thalamus (Temporal)
$((nSchaefer + 13)),L,SomMot,Posterior Putamen
$((nSchaefer + 14)),L,SalVentAttn,Anterior Putamen
$((nSchaefer + 15)),L,Limbic,Ventral Striatum
$((nSchaefer + 16)),L,Cont,Caudate Tail and Lateral Putamen
$((nSchaefer + 17)),L,Default,Caudate Head
$((nSchaefer + 18)),R,SomMot,Posterior Putamen
$((nSchaefer + 19)),R,SalVentAttn,Anterior Putamen
$((nSchaefer + 20)),R,Limbic,Ventral Striatum
$((nSchaefer + 21)),R,Cont,Caudate Tail and Lateral Putamen
$((nSchaefer + 22)),R,Default,Caudate Head
...
$((nSchaefer + 31)),L,Vis,Cerebellum
$((nSchaefer + 32)),L,SomMot,Cerebellum
$((nSchaefer + 33)),L,DorsAttn,Cerebellum
$((nSchaefer + 34)),L,SalVentAttn,Cerebellum
$((nSchaefer + 35)),L,Limbic,Cerebellum
$((nSchaefer + 36)),L,Cont,Cerebellum
$((nSchaefer + 37)),L,Default,Cerebellum
$((nSchaefer + 38)),R,Vis,Cerebellum
$((nSchaefer + 39)),R,SomMot,Cerebellum
$((nSchaefer + 40)),R,DorsAttn,Cerebellum
$((nSchaefer + 41)),R,SalVentAttn,Cerebellum
$((nSchaefer + 42)),R,Limbic,Cerebellum
$((nSchaefer + 43)),R,Cont,Cerebellum
$((nSchaefer + 44)),R,Default,Cerebellum

# The current working directory is: $PWD
# You are logged in as: $(whoami)
EOF

# lookup coordinates of all regions in atlases
./lookup_roi_names.R Schaefer_$((nSchaefer + nAddl))_final_${sz}mm.nii.gz region_lookup.csv